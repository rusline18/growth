...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 26 2016 г., 17:18
...
INSERT INTO `Categoria` (`idCateg`, `category`) VALUES
(1, 'Автомобиль'),
(2, 'Налоги');
...
INSERT INTO `organization` (`idOrg`, `organization`, `sector`) VALUES
(1, 'Макдональдс', 'Общественное питание'),
(2, 'Лукойл', 'АЗС'),
(3, 'Выберите организацию', 'Неизвестно');
...
INSERT INTO `score` (`idScore`, `idUser`, `score`, `currency`, `typ`) VALUES
(6, 6, 'Кошелек', 'Рубль', 'Наличные'),
(7, 6, 'наличные', 'Рубль', 'Наличные'),
(8, 6, 'Кошелек', 'Рубль', 'Наличные'),
(9, 6, 'Зарплатная карта', 'Рубль', 'Дебетовая карта'),
(10, 6, 'Вклад', 'Доллар', 'Кредитная карта'),
(11, 6, 'Вклад', 'Доллар', 'Вклад'),
(12, 6, 'Вклад', 'Евро', 'Вклад'),
(13, 6, 'наличные', 'Рубль', 'Вклад'),
(14, 6, 'кредитная карта', 'Евро', 'Кредитная карта');
...
INSERT INTO `subcategory` (`idSubCat`, `idCateg`, `subcategory`) VALUES
(3, 1, 'Бензин'),
(4, 1, 'Ремонт'),
(5, 2, 'Госпошлина'),
(6, 2, 'Сбор');
...
INSERT INTO `transactions` (`idTrans`, `idUser`, `idScore`, `typ`, `idCateg`, `idSubCat`, `idOrg`, `data`, `Sum`, `comment`) VALUES
(11, 6, 6, 'Доход', 1, 4, 2, '2016-12-06', 100, 'тест'),
(12, 6, 6, 'Расход', 2, 6, 1, '2016-12-08', 200.5, 'тест'),
(13, 6, 6, 'Расход', 2, 5, 2, '2016-11-28', 300, 'тест'),
(14, 6, 6, 'Перевод', 1, 3, 2, '2016-12-05', 5000, 'тест'),
(16, 6, 7, 'Доход', 1, 4, 2, '2016-12-05', 5000, 'test'),
(17, 6, 9, 'Расход', 2, 5, 1, '2016-12-15', 6000, 'test'),
(18, 6, 6, 'Перевод', 1, 3, 2, '2016-12-06', 200, 'тест'),
(23, 6, 9, 'Доход', 1, 3, 3, '2016-12-14', 1000, ''),
(36, 6, 10, 'Доход', 1, 3, 2, '2015-06-17', 100000, '');
...
INSERT INTO `user` (`id`, `LastName`, `name`, `floor`, `email`, `password`, `phone`, `data`, `country`, `region`, `city`, `rdate`, `activation`, `status`) VALUES
(1, 'Маратов', 'Марат', '0', 'absaruslan9@mail.ru', '778bf48445ac66c16da443307a97898d', '+7950316423', '0000-00-00', '0', '', '', '2016-11-15 20:20:46', '93d8c8239628efdefc18afd7cc9ce3c7', '0'),
(2, 'Маратов', 'Марат', '1', 'absaruslan9@yandex.ru', '277d521cc4c08f7249e405ef06061279', '', '0000-00-00', '0', '', '', '2016-11-15 20:58:32', '9864ec4df80dc0847c862fb45b5f29d0', '0'),
(3, 'Маратов', 'Марат', '1', 'test@m.ru', '277d521cc4c08f7249e405ef06061279', '', '0000-00-00', '0', '', '', '2016-11-16 20:21:18', 'abfe0a7b2b07adc8d4a45f249059f2ac', '0'),
(6, 'Абсалямов', 'Руслан', '1', 'absaruslan90@mail.ru', '277d521cc4c08f7249e405ef06061279', '89503164233', '1990-12-11', '3159', '5246', '5269', '2016-11-20 11:58:36', '', '1');
...
ALTER TABLE `Categoria`
  ...
  ADD UNIQUE KEY `Categoria` (`category`);
...
ALTER TABLE `organization`
  ...
  ADD UNIQUE KEY `name` (`organization`),
...
ALTER TABLE `subcategory`
  ...
  ADD UNIQUE KEY `name` (`subcategory`),
...
ALTER TABLE `transactions`
  ...
  ADD KEY `idOrg` (`idOrg`),
  ADD KEY `idScore` (`idScore`) USING BTREE,
...
--
ALTER TABLE `city`
  MODIFY `city_id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=15789521;
--
...
--
ALTER TABLE `organization`
  MODIFY `idOrg` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT для таблицы `region`
--
ALTER TABLE `region`
  MODIFY `region_id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=15789406;
--
-- AUTO_INCREMENT для таблицы `score`
--
ALTER TABLE `score`
  MODIFY `idScore` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=15;
--
...
--
ALTER TABLE `score`
  ADD CONSTRAINT `score_ibfk_1` FOREIGN KEY (`idUser`) REFERENCES `user` (`id`) ON UPDATE CASCADE;

--
-- Ограничения внешнего ключа таблицы `subcategory`
--
ALTER TABLE `subcategory`
  ADD CONSTRAINT `subcategory_ibfk_1` FOREIGN KEY (`idCateg`) REFERENCES `Categoria` (`idCateg`) ON UPDATE CASCADE;

--
-- Ограничения внешнего ключа таблицы `transactions`
--
ALTER TABLE `transactions`
  ADD CONSTRAINT `transactions_ibfk_4` FOREIGN KEY (`idScore`) REFERENCES `score` (`idScore`),
  ADD CONSTRAINT `transactions_ibfk_6` FOREIGN KEY (`idCateg`) REFERENCES `Categoria` (`idCateg`) ON UPDATE CASCADE,
  ADD CONSTRAINT `transactions_ibfk_7` FOREIGN KEY (`idSubCat`) REFERENCES `subcategory` (`idSubCat`) ON UPDATE CASCADE,
  ADD CONSTRAINT `transactions_ibfk_8` FOREIGN KEY (`idUser`) REFERENCES `user` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `transactions_ibfk_9` FOREIGN KEY (`idOrg`) REFERENCES `organization` (`idOrg`) ON UPDATE CASCADE;
